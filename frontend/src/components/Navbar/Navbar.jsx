  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl shadow-sm dark:shadow-none">
      ...
      <button
        ...
        className="px-5 py-2 text-blue-700 dark:text-blue-400 font-bold hover:bg-slate-50 dark:hover:bg-slate-800/50 rounded-lg transition-all scale-95 active:scale-90 duration-200"
      >
        Login
      </button>
      ...
      <button
        ...
        className="px-6 py-2 bg-primary text-white rounded-xl font-bold hover:shadow-lg transition-all scale-95 active:scale-90 duration-200"
      >
        Signup
      </button>
