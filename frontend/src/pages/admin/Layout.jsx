...
const Layout = () => {
  ...
  const menuItems = [
    ...
    { name: 'user', path: '/admin/user', icon: 'calendar_today' },
    { name: 'provider', path: '/admin/provider', icon: 'shopping_cart' },
    // { name: 'prescriptions', path: '/admin/prescriptions', icon: 'inventory_2' },
