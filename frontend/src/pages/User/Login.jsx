...
<p className="text-on-surface-variant">Please enter your credentials to access your account.</p>
</div>
{/* <!-- Form Card --> */}
...
<label className="block text-xs font-label text-on-surface-variant tracking-wider uppercase" for="id_field">Email or Phone Number</label>
<div className="relative group">
<div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-outline">
<span className="material-symbols-outlined text-lg">person</span>
</div>
<input className="block w-full pl-11 pr-4 py-4 bg-surface-container-highest border-none rounded-xl text-on-surface focus:ring-2 focus:ring-primary focus:bg-surface-container-lowest transition-all placeholder:text-outline" id="id_field" placeholder="johndoe@example.com" type="text"/>
</div>
</div>
{/* <!-- Password Field --> */}
<div className="space-y-2">
<label className="block text-xs font-label text-on-surface-variant tracking-wider uppercase" for="password">Password</label>
<div className="relative group">
<div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-outline">
<span className="material-symbols-outlined text-lg">lock</span>
</div>
<input className="block w-full pl-11 pr-12 py-4 bg-surface-container-highest border-none rounded-xl text-on-surface focus:ring-2 focus:ring-primary focus:bg-surface-container-lowest transition-all placeholder:text-outline" id="password" placeholder="••••••••" type="password"/>
...
<input className="w-5 h-5 rounded border-outline-variant text-primary focus:ring-primary/20 bg-surface-container-high transition-all" type="checkbox"/>
...
{/* <!-- Primary CTA --> */}
<button className="w-full py-4 bg-gradient-to-br from-primary to-primary-container text-white font-semibold rounded-xl shadow-lg hover:shadow-primary/20 transform active:scale-[0.98] transition-all" type="submit">
                            Login
                        </button>
{/* <!-- Divider --> */}
<div className="relative flex items-center justify-center py-2">
<div className="w-full h-px bg-outline-variant/30"></div>
<span className="absolute px-4 bg-surface-container-lowest text-xs font-label text-outline uppercase tracking-widest">Or continue with</span>
</div>
{/* <!-- Secondary OAuth --> */}
<button className="w-full py-4 bg-surface-container-high text-on-primary-fixed-variant font-semibold rounded-xl flex items-center justify-center gap-3 hover:bg-surface-container-highest transition-all group" type="button">
...
<span className="text-xs font-label uppercase tracking-widest">Secure &amp; encrypted</span>
</div>
</div>
</div>
</section>
